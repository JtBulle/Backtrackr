...
<main class="bg-bg-dark p-4 font-mono">
  <h2 class="mt-0 mb-3 text-xl font-bold text-text">Backtrackr</h2>
  ...
  <button
    class="mt-3 cursor-pointer rounded border-none bg-text px-4 py-2 text-base text-bg-dark hover:bg-text-muted"
